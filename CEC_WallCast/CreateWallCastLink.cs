...
namespace CEC_WallCast
{
    ...
    public class CreateWallCastLink : IExternalCommand
    {
#if RELEASE2019
            ...
            while (true)
            {
                try
                {
                    ...
                    using (Transaction trans = new Transaction(doc))
                    {
                        ...
                        if (HoleLocation != null)
                        {
                            FamilySymbol CastSymbol2 = new WallCast().findWall_CastSymbol(doc, Wall_Cast, linkedPipe);
                            ...
                            //調整高度與長度
                            Parameter pa = linkedPipe.get_Parameter(BuiltInParameter.RBS_OFFSET_PARAM);
